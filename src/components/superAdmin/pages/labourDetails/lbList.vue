<template>
    <div class="sup_content customer-list">
        <div class="sup_page_heading">
            ...
            <Button v-if="customerAdd" icon="pi pi-plus" class="p-button-sm p-button-rounded p-button-primary" v-tooltip="'Add labour'" @click="labourModal.addCustomer = true" />
        </div>
        <div class="sup_inner_content">
            <!--- Show Customer Table Start --->
            <DataTable class="p-datatable" :paginator="true" :value="allLabourData.data" :rows="10" paginatorTemplate="CurrentPageReport FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown" currentPageReportTemplate="Showing {currentPage} of {totalPages}" :rowsPerPageOptions="[10,20,50]" :rowHover="true" :loading="allLabourData.loading" responsiveLayout="scroll" removableSort :filters="filters">
                <template #loading>
                ...
                <template #header>
                    <div class="p-d-flex p-jc-between">
                        <div class="sup_list_action">
                            <Button v-if="customerDeactivateList" :label="allLabourData.activityStatus === 'active' ? 'Deactive List': 'Active List'" :icon="['pi', allLabourData.activityStatus === 'active' ? 'pi-ban' : 'pi-check-circle']" :class="[allLabourData.activityStatus === 'active' ? 'p-button-danger' : 'p-button-primary', 'p-mr-2']" @click="fetchAllLabours(allLabourData.activityStatus, 'customerStatus')" />
                        </div>
                        <div class="p-d-flex p-align-center">
                            <span class="p-input-icon-left sup_search_box">
                                <i class="pi pi-search" />
                                <InputText v-model="allLabourData.search" placeholder="Search Customer" @keyup.enter="fetchAllLabours(allLabourData.activityStatus, 'search')"/>
                            </span>
                            <Calendar v-model="allLabourData.dateRange" placeholder="DD.MM.YY" dateFormat="dd.mm.yy" selectionMode="range" class="sup_button p-ml-2" inputClass="p-inputtext" :manualInput="false" :showIcon="true" @date-select="allLabourData.dateRange[1] != null ? fetchAllLabours(allLabourData.activityStatus, 'dateRange') : ''" plceholder="abc" />
                            <Button v-if="allLabourData.search !== null || allLabourData.dateRange !== null" icon="pi pi-refresh" class="p-button-sm p-button-dark sup_search_clear p-ml-2" @click="fetchAllLabours(allLabourData.activityStatus, 'resetFilters')"/>
        ...
        <Dialog header="Add New Customer" v-model:visible="labourModal.addCustomer" :modal="true" :style="{width: '600px'}" @hide="closeModal()">
            <form class="sup_customer_add" @submit.prevent="createLabours()">
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        <label for="u_name">Name<span class="text-danger">*</span></label>
                        <InputText v-model="addEditLabour.name" id="u_name" type="text" />
                    ...
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.email" id="u_email" type="text" />
                ...
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.phone" id="u_mobile" type="text" />
                    ...
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.company" id="u_company" type="text" />
                ...
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        ...
                        <Dropdown v-model="addEditLabour.country" :options="alllocationData.country" id="u_country" optionLabel="name" optionValue="uuid" placeholder="Select a Country" @change="fetchLocation('countryOnchange')" />
                    ...
                    <div class="p-field p-col-6">
                        ...
                        <Dropdown v-model="addEditLabour.state" :options="alllocationData.state" id="u_state" optionLabel="name" optionValue="uuid" placeholder="Select a State" />
                ...
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.city" id="u_city" type="text" />
                    </div>
                    <div class="p-field p-col-6">
                        <label for="u_state">Zipcode<span class="text-danger">*</span></label>
                        <InputText v-model="addEditLabour.zipCode" id="u_zipcode" type="text" />
                    </div>
                </div>
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        <label for="u_intro">Intro</label>
                        <InputText v-model="addEditLabour.intro" id="u_intro" type="text" />
                    </div>
                    <div class="p-field p-col-6">
                        <label for="u_profile">Profile</label>
                        <InputText v-model="addEditLabour.profile" id="u_profile" type="text" />
                    </div>
                </div>
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        <label for="u_password">Password<span class="text-danger">*</span></label>
                        <InputText v-model="addEditLabour.password" id="u_password" type="password" />
                    ...
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.confirmPassword" id="u_confirm_password" type="password" />
                ...
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.address1" id="u_address1" type="text" />
                    </div>
                    <div class="p-field p-col-6">
                        <label for="u_address2">Address2</label>
                        <InputText v-model="addEditLabour.address2" id="u_address2" type="text" />
                    </div>
                </div>
                <div class="p-fluid p-d-flex sup_submit_wrap">
                    <Button type="submit" label="Add" class="btn-primary sup_submit" />
                </div>
                <div :class="['sup_form_massage p-mt-3', allLabourData.addStatus === 200 ? 'success' : 'error']" v-if="allLabourData.addStatus !== ''">{{allLabourData.addMessage}}</div >
            </form>
        </Dialog>
        <!--- Add Customer Modal End --->
        <!--- Edit Customer Modal Start --->
        <Dialog v-model:visible="labourModal.editCustomer" :modal="true" :style="{width: '600px'}" @hide="closeModal()">
            <template #header>
            ...
            <form class="sup_user_edit" @submit.prevent="updateUser(editModaldata.value.uuid)">
                <div class="p-fluid p-formgrid p-grid">
                    ...
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.email" id="u_email" type="text" readonly />
                ...
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        ...
                        <Dropdown v-model="addEditLabour.country" :options="alllocationData.country" id="u_country" optionLabel="name" optionValue="uuid" placeholder="Select a Country" @change="fetchLocation('onchange')" />
                ...
                <div class="p-fluid p-formgrid p-grid">
                    ...
                    <div class="p-field p-col-6">
                        ...
                        <InputText v-model="addEditLabour.zipCode" id="u_zip" type="text" />
                    </div>
                </div>
                <div class="p-fluid p-formgrid p-grid">
                    <div class="p-field p-col-6">
                        <label for="u_address_1">Address 1</label>
                        <InputText v-model="addEditLabour.address1" id="u_address_1" type="text" />
                    </div>
                    <div class="p-field p-col-6">
                        <label for="u_address_2">Address 2</label>
                        <InputText v-model="addEditLabour.address2" id="u_address_2" type="text" />
                    </div>
                </div>
                <div class="p-fluid p-d-flex sup_submit_wrap">
                ...
                <div :class="['sup_form_massage p-mt-3', allLabourData.editStatus === 200 ? 'success' : 'error']" v-if="allLabourData.editStatus !== ''">{{'User has been updated ' + allLabourData.editMessage}}</div >
            </form>
        </Dialog>
        <!--- Edit Customer Modal End --->
        <!--- View Customer Modal Start --->
        <Dialog v-model:visible="labourModal.viewCustomer" class="sub_customer_view" :modal="true" :style="{width: '600px'}">
            <template #header>
            ...
            <template #footer>
                <Button icon="pi pi-pencil" label="Edit Customer" class="p-button-primary p-button-sm sup_customer_edit_btn" @click="labourModal.viewCustomer = false;viewEdit(editModaldata.value, 'editCustomer')" />
                <Button label="Deactivate" icon="pi pi-ban" class="p-button-danger p-button-sm" />
                <Button label="Cancel" icon="pi pi-times" class="p-button-plain p-button-sm p-button-text" @click="labourModal.viewCustomer = false" autofocus />
            </template>
        </Dialog>
        ...
        <Dialog header="Confirmation" v-model:visible="confirmationModal.modalState" :style="{width: '350px'}" :modal="true">
            ...
            <template #footer>
                ...
                <Button label="Yes" icon="pi pi-check" @click="deleteAndRestoreLabour(confirmationModal.modaldata.data, confirmationModal.modaldata.load), confirmationModal.modalState = false" class="p-button-primary" />
            </template>
        </Dialog>
...
<script>
import { allLabours, allLocation, laboursById, editLabour, deleteLabour, addLabour } from '../../../../config/appUrls';
...
export default({
    setup() {
         ...
         */
        const fetchAllLabours = async (customerStatus, load) => {
            let date = null;
            //Toggle Customer status to fetch active/deactive role
            if(load === 'customerStatus'){
                allLabourData.activityStatus = customerStatus === 'active' ? 'de-active' : 'active' ;
            }

            //To clear search and filter then fetch all data
            if(load === 'resetFilters'){
                allLabourData.search = null;
                allLabourData.dateRange = null;
            }

            //Filter date wise code
            if (load === 'dateRange') {
                date = formatDate(allLabourData.dateRange[0]) + ' ' + formatDate(allLabourData.dateRange[1]);
            }

            //API call start
            try{
                allLabourData.loading = !allLabourData.loading;
                const response = await axios.get( allLabours, {
                    params: {
                        status: allLabourData.activityStatus,
                        search: allLabourData.search,
                        filterDt: date
                    },
                    headers: {
                        apiKey: apiKey,
                    ...
                    allLabourData.data = response.data.data.users;
                    allLabourData.total = response.data.data.total;
                    allLabourData.loading = !allLabourData.loading;
            } catch(err){
         ...
         * After API success calling customer list again by fetchAllLabours()
         * And reseting form value
         */
        const createLabours = async () => {
            const isValidate = fromValidation();
            if (isValidate) {
                try{
                    const response = await axios.post( addLabour,{
                        countryId: addEditLabour.country,
                        stateId: addEditLabour.state,
                        name: addEditLabour.name,
                        email: addEditLabour.email,
                        mobile: addEditLabour.phone,
                        company: addEditLabour.company,
                        city: addEditLabour.city,
                        addressOne: addEditLabour.address1,
                        addressTwo: addEditLabour.address2,
                        zipcode: addEditLabour.zipCode,
                        intro: addEditLabour.intro,
                        profile: addEditLabour.profile,
                        password: addEditLabour.password,
                    },{
                        headers: {
                            apiKey: apiKey,
                            token: store.getters.adminAuthToken
                    ...
                    if(response.status === 200) {
                        allLabourData.addStatus = response.data.status;
                        allLabourData.addMessage = response.data.data;
                        fetchAllLabours();
                        addEditFormReset();
                    }
                } catch(err){
                    allLabourData.addStatus = err.response.data.status;
                    allLabourData.addMessage = err.response.data.message;
                }
            }
        }
        ...
        const viewEdit = async (slotData, load) => {
            const response = await axios.get( laboursById, {
                params: {
                    uuid: slotData.uuid,
                }, 
                headers: {
            ...
            if (response.data.status === 200) {
                ...
                if (load === 'editCustomer') { //On edit every input data updation
                    labourModal.editCustomer = true;
                    editModaldata.value = slotData;
                    addEditLabour.name = response.data.data.name;
                    addEditLabour.email = response.data.data.email;
                    addEditLabour.email = response.data.data.email;
                    addEditLabour.phone = response.data.data.mobile;
                    addEditLabour.company = response.data.data.company;
                    addEditLabour.city = response.data.data.city;
                    addEditLabour.zipCode = response.data.data.zipcode;
                    addEditLabour.address1 = response.data.data.addressOne;
                    addEditLabour.address2 = response.data.data.addressTwo;
                    addEditLabour.country = response.data.data.countryId;
                    addEditLabour.state = response.data.data.stateId;
                    addEditLabour.role = response.data.data.roleId;
                    addEditLabour.intro = response.data.data.intro;
                    addEditLabour.profile = response.data.data.profile;

                    fetchLocation('onchange');

                } else { //On view full API data value store to a value
                    labourModal.viewCustomer = true;
        ...
        const updateUser = async (uuid) => {
            ...
            try{
                ...
                allLabourData.editStatus = response.data.status;
                allLabourData.editMessage = response.data.message;
                fetchAllLabours('active');
            } catch(err){
                allLabourData.editStatus = err.response.data.status;
                allLabourData.editMessage = err.response.data.message;
            }
        }
        ...
        const fromValidation = () => {
            const emailValid = validateEmail(addEditLabour.email);
            const mobileValid = validateMobile(addEditLabour.phone);

            if (!addEditLabour.name) {
            ...
            if(!validatePassword(addEditLabour.password).lValidation){
                addEditvalidationError.PasswordEmpty = true;
            } else {
                addEditvalidationError.PasswordEmpty = false;
            }

            if(!validatePassword(addEditLabour.confirmPassword).lValidation){
                addEditvalidationError.ConfrmPasswordEmpty = true;
            } else {
                addEditvalidationError.ConfrmPasswordEmpty = false;
            }

            if(!matchPassword(addEditLabour.password, addEditLabour.confirmPassword)) {
        ...
        const addEditFormReset = () => {
            ...
            addEditLabour.email = '';
            addEditLabour.phone = '';
            addEditLabour.company = '';
            addEditLabour.city = '';
            addEditLabour.zipCode = '';
            addEditLabour.address1 = '';
            addEditLabour.address2 = '';
            addEditLabour.country = '';
            addEditLabour.state = '';
            addEditLabour.intro = '';
            addEditLabour.profile = '';
            addEditLabour.password = '';
            addEditLabour.confirmPassword = '';
        }
        ...
        const closeModal = () => {
            addEditFormReset();
            allLabourData.addStatus= '',
            allLabourData.addMessage= '',
            allLabourData.editStatus = '';
            allLabourData.editMessage = '';
        }
        ...
        //     if (load === 'excel') {
        //         try{
        //             if (allLabourData.dateRange !== null) {
        //                 date = formatDate(allLabourData.dateRange[0]) + ' ' + formatDate(allLabourData.dateRange[1]);
        //             }
