        ...
        <div class="up_main_contianer_full">
            <div class="up_left_block">
                ...
                <div class="up_logo_wrap">
                    <router-link to="/contractors/dashboard" class="up_logo">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRHpcqwj6RuBnis9zCi-ECPX9JsebA6WccrOG7Wm5O0nkjMdcjEVTX07sC75WG4d2El0o&usqp=CAU" class="lms-image" alt="contractor Image">
                    </router-link>
                </div>
