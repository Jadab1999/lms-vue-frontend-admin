      ...
      <div class="iphone">
        <div class="header">
          ...
          <div class="user-profile">
            <img src="../../../assets/images/labours/profile-wallet.png" class="user-photo">
          </div>
        </div>
        <div class="content">
          <div class="card">
            <div class="upper-row">
              <div class="card-item">
                ...
                1&nbsp;804 <span class="dollar">&#8377;</span>
              </div>
              <div class="card-item">
                <span>My Save it</span>
                2&nbsp;000 <span class="dollar">&#8377;</span>
              </div>
            </div>
            <div class="lower-row">
              <div class="icon-item">
...
<style lang="scss">
@import '../../../assets/style/component/userportal/pages/wallet/wallet.css';
</style>